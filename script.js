...
async function renderDashboard() {
  ...
  try {
    ...
    widgetArea.appendChild(
      createWidget("GA Pageviews", analyticsData.pageviews)
    );
    widgetArea.appendChild(
      createWidget("GA Unique Visitors", analyticsData.uniqueVisitors)
    );
    widgetArea.appendChild(createWidget("GA Sessions", analyticsData.sessions));
    widgetArea.appendChild(
      createWidget("GA Bounce Rate", analyticsData.bounceRate)
    );
  } catch (error) {
